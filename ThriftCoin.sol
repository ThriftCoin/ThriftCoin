...
contract ThriftCoin is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "ThriftCoin";
    ...
    uint256 public _liquidityFee = 6; // 3% will be added pool, 3% will be converted to BNB
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own ThriftCoin to claim reward');
